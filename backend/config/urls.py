...
from apps.novedades.views import sugerir_motivo
...
from apps.novedades.views import count_alertas_criticas
...
from apps.novedades.views import AdminEtapasFlujo
from apps.novedades.views import AdminEtapaFlujoDetalle
from apps.novedades.views import listar_etapas_flujo
from apps.novedades.views import ClienteResponderNovedad
from apps.novedades.views import staff_vista_cliente_listar_novedades
from apps.novedades.views import StaffVistaClienteNovedadDetalle
from apps.novedades.views_portal import (
    portal_listar_novedades,
    PortalNovedadDetalle,
    portal_listar_notificaciones,
    PortalMarcarNotificacionesLeidas,
)
...
urlpatterns = [
    ...
    path('api/novedades/<int:novedad_id>/sugerir-motivo/', sugerir_motivo, name='sugerir-motivo'),
    ...
    path('api/novedades/alertas-criticas/count/', count_alertas_criticas, name='count-alertas-criticas'),
    ...
    path('api/admin/clientes/', AdminClientes.as_view(), name='admin-clientes'),
    path('api/admin/clientes/<int:cliente_id>/', AdminClienteDetalle.as_view(), name='admin-cliente-detalle'),
    path('api/dashboard/resumen/', dashboard_resumen, name='dashboard-resumen'),
    ...
    path('api/admin/etapas-flujo/', AdminEtapasFlujo.as_view(), name='admin-etapas-flujo'),
    path('api/admin/etapas-flujo/<int:etapa_id>/', AdminEtapaFlujoDetalle.as_view(), name='admin-etapa-flujo-detalle'),
    path('api/etapas-flujo/', listar_etapas_flujo, name='listar-etapas-flujo'),
    path('api/portal/novedades/', portal_listar_novedades, name='portal-listar-novedades'),
    path('api/portal/novedades/<int:novedad_id>/', PortalNovedadDetalle.as_view(), name='portal-novedad-detalle'),
    path('api/portal/novedades/<int:novedad_id>/responder/', ClienteResponderNovedad.as_view(), name='portal-responder-novedad'),
    path('api/portal/notificaciones/', portal_listar_notificaciones, name='portal-listar-notificaciones'),
    path('api/portal/notificaciones/marcar-leidas/', PortalMarcarNotificacionesLeidas.as_view(), name='portal-marcar-notificaciones-leidas'),
    path('api/admin/vista-cliente/novedades/', staff_vista_cliente_listar_novedades, name='staff-vista-cliente-novedades'),
    path('api/admin/vista-cliente/novedades/<int:novedad_id>/', StaffVistaClienteNovedadDetalle.as_view(), name='staff-vista-cliente-novedad-detalle'),
]
